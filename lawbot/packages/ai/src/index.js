...
export class AI {
    ...
    async chat(request) {
        try {
            ...
            const context = await this.contextBuilder.buildContext(request.query, request.conversationId);
            // Save user message
            ...
            return await this.streamHandler.createStreamResponse(llmResponse, async (fullText) => {
 ...
 */
export function createAI(env, ragSearch) {
