...
import type { ZaloQuickReplyOption, Citation } from '@lawbot/shared';
...
Hãy gửi câu hỏi của bạn hoặc chọn một trong các tùy chọn bên dưới.`,
  ...
  errorMessages: {
    ...
    rateLimitExceeded:
      'Bạn đã gửi quá nhiều tin nhắn. Vui lòng chờ một chút trước khi tiếp tục.',
  },
...
export function formatErrorMessage(
  errorType: keyof typeof messageTemplates.errorMessages
): string {
