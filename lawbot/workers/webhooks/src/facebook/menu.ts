 ...
 */
async function setPersistentMenu(client: MessengerClient): Promise<void> {
  const menu = {
    persistent_menu: [
      {
        locale: 'default',
 ...
 * Set greeting text
 */
async function setGreeting(client: MessengerClient): Promise<void> {
  const greeting = {
    greeting: [
      {
        locale: 'default',
 ...
 * Set get started button
 */
async function setGetStartedButton(client: MessengerClient): Promise<void> {
  const getStarted = {
    get_started: {
      payload: 'GET_STARTED',
    },
 ...
 */
export async function removePersistentMenu(
  pageAccessToken: string
): Promise<void> {
  const client = new MessengerClient(pageAccessToken);
 ...
 */
export async function updateMenuLocale(
  pageAccessToken: string,
  locale: string,
  menuItems: Array<{
    title: string;
